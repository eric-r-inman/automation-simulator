//! automation-simulator-server - General-purpose long-running service
//!
...
async fn main() -> Result<(), ApplicationError> {
  ...
  info!("Starting automation-simulator-server");
  ...
  info!("Shutting down automation-simulator-server");
  Ok(())
}
