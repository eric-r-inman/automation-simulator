{
  description = "Food forest automation system";
  inputs = {
  ...
  outputs = {
    ...
    workspaceCrates = {
      # CRATE:cli:begin
      cli = {
        name = "automation-simulator-cli";
        binary = "automation-simulator-cli";
        description = "Command-line entry point for running food forest automation scenarios";
      };
      # CRATE:cli:end

      # CRATE:server:begin
      server = {
        name = "automation-simulator-server";
        binary = "automation-simulator-server";
        description = "HTTP server exposing the food forest automation simulator";
      };
      # CRATE:server:end
  ...
  in {
    ...
    in {
      default = pkgs.mkShell {
        ...
        shellHook = ''
          echo "automation-simulator development environment"
          echo ""
    ...
    in
      ...
      // {
        ...
        default = craneLib.buildPackage (commonArgs // {pname = "automation-simulator";});
      });
